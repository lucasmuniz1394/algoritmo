// 1 - Fulano precisa de um software que ao passar uma entrada, ele imprime os valores de 0 até valor X que ele passar,
// ele quer automatizar isso para otimizar seu tempo e ser mais produtivo.
...
const rl = readline.createInterface({input:process.stdin, //informa entrada
            output: process.stdout //informa saida
});

rl.question("Insira um valor sera percorrido:", (valorfinal) =>{
